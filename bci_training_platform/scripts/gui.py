#!/usr/bin/env python
import pygame, sys, os, random, rospy, rospkg
...
def inicio():
    ...
    sound = pygame.mixer.Sound(mypath+"resources/sounds/intro_sound2.ogg")
    beep = pygame.mixer.Sound(mypath+"resources/sounds/beep.ogg")
    ...
    USER=[]
    FPS = 15
    pygame.display.set_icon(pygame.image.load(mypath+"resources/images/icon.jpg"))
    pygame.display.set_caption("Exodia Platform")
    global bg1,bg2,up,down,left,right,cruz,pause,menu,ghost,star
    bg1=pygame.image.load(mypath+"resources/images/background/bg1.jpg")
    bg2=pygame.image.load(mypath+"resources/images/background/bg2.jpg")
    up=pygame.image.load(mypath+"resources/images/UP.jpg")
    down=pygame.image.load(mypath+"resources/images/DOWN.jpg")
    left=pygame.image.load(mypath+"resources/images/LEFT.jpg")
    right=pygame.image.load(mypath+"resources/images/RIGHT.jpg")
    cruz=pygame.image.load(mypath+"resources/images/CRUZ.jpg")
    pause=pygame.image.load(mypath+"resources/images/clock.jpg")
    menu=pygame.image.load(mypath+"resources/images/background/menu1.jpg")
    ghost=pygame.image.load(mypath+"resources/images/ghostred.jpg")
    star=pygame.image.load(mypath+"resources/images/star.jpg")
    screen.fill(gray)
...
def new_calibration():
    ...
    shuffle(lista)
    try:
        os.makedirs(mypath+"users/"+USER)
    except:
        if not os.path.isdir(mypath+"users/"+USER):
            raise
    i=0
    while True:
        try:
            file = open(mypath+"users/"+USER+"/calibration%s.txt" % i, 'r')
        except:
            break
        i=i+1
