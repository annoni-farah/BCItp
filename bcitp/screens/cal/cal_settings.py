...
class CalSettings(Screen):
    ...
    def save_config(self, *args):
        ...
        self.sh.cal.data_cal_path = PATH_TO_SESSION + \
            self.sh.info.name + '/' + 'data_cal.npy'
        self.sh.cal.events_cal_path = PATH_TO_SESSION + \
            self.sh.info.name + '/' + 'events_cal.npy'
        self.sh.cal.data_val_path = PATH_TO_SESSION + \
            self.sh.info.name + '/' + 'data_val.npy'
        self.sh.cal.events_val_path = PATH_TO_SESSION + \
            self.sh.info.name + '/' + 'events_val.npy'
