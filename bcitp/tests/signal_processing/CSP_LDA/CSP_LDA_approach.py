...
t_events = np.loadtxt(open(train_events_path, "rb"),
...
epoch_trainA = extractEpoch(
    data_train, t_events, codeA, epoch_start, epoch_end)
epoch_trainB = extractEpoch(
    data_train, t_events, codeB, epoch_start, epoch_end)
