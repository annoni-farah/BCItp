...
c_time = np.append(c_time,  -np.ones(20))
c_time = np.append(c_time,  np.ones(50))
c_time = np.append(c_time,  -np.ones(30))
c_time = np.append(c_time,  np.ones(150))
# c_time = np.append(c_time,  -np.ones(10))
# c_time = np.append(c_time,  np.ones(40))
