...
# layout
    ...
    def load_cal_config(self):
        with open("data/rafael" + "/cal_config.txt", "r") as file:
            ...
            self.cue_offset.readonly = True
            self.pause_offset.readonly = True
            self.epoch_start.readonly = True
            self.epoch_end.readonly = True

    def save_config(self,*args):

        with open("data/rafael" + "/val_config.txt", "w") as file:
