...
class GeneralSettings(Screen):
    ...
    def __init__(self, session_header, **kwargs):
        ...
        label_cal_path = Label(
            text='Path to Calibration Data: ', font_size=FONT_SIZE)
        self.cal_path = TextInput(font_size=FONT_SIZE,
                                  text='', multiline=False)

        label_cal_path_ev = Label(
            text='Path to Calibration Events: ', font_size=FONT_SIZE)
        self.cal_path_ev = TextInput(font_size=FONT_SIZE,
                                     text='', multiline=False)

        label_val_path = Label(
            text='Path to Validation Data: ', font_size=FONT_SIZE)
        self.val_path = TextInput(font_size=FONT_SIZE,
                                  text='', multiline=False)

        label_val_path_ev = Label(
            text='Path to Validation Events: ', font_size=FONT_SIZE)
